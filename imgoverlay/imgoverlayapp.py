...
class OverlayApp:
    ...
    def __init__(self):
        ...
        self.parser = ArgumentParser(description='A simple tool for overlaying some text on an image.')
        ...
        self.parser.add_argument('-s', '--size', type=int, help='The font size of the text.')
        self.parser.add_argument('-c', '--colour', type=str, help='The colour of the text.')
